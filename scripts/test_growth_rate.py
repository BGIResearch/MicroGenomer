...
def main(args):
    ...
    USE_ATTENTION = True
    epoch = 55
    pt_path = f'./weights/downstream_tasks/train_attn_growth_rate/len8000_attentionTrue/55_gene_attn_optim_model.pt'
    txt_path = './scripts/data/genome_unique_ids.csv'
    task = 'growth_rate' 
    output_folder = args.output_dir + f'/test_attn_{task}'
    os.makedirs(output_folder, exist_ok=True)

    train_path = './scripts/data/split_meta_growth_phylo.csv'  
    ...
    test_dataset = GrowthDataset(data_df, max_length=max_length)
