...
Since the model leverages FlashAttention for computational acceleration to enhance the efficiency of genomic representation extraction, we recommend the following hardware configurations to ensure optimal model performance:
